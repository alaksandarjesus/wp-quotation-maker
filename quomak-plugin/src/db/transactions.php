...
class Transactions
{
    ...
    {
        $this->log = new Log('db.transactions');
        $this->create_table();
        $this->alter_table();
    }
    ...
    {
        $this->log->info('Creating new transactions if table not exists');
        ...
        $create_table_query = "
                CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}{$this->tablename}` (
                  ...
                  `invoice_item_id` INTEGER(10) NOT NULL,
    ...
    public function alter_table()
    {
        ...
        $this->log->info('Altering table transactions table');
