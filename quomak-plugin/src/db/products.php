...
class Products
{
    ...
    {
        $this->log->info('Creating new products if table not exists');
    ...
    public function alter_table()
    {
        ...
        $this->log->info('Altering table products table');
