...
class ProductRelated
{
    ...
    {
        $this->log = new Log('db.product-related');
        $this->create_table();
        $this->alter_table();
    }
    ...
    {
        $this->log->info('Creating new productRelated if table not exists');
        ...
        $create_table_query = "
                CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}{$this->tablename}` (
                  ...
                  `related_product_id` INTEGER(10) NOT NULL,
    ...
    public function alter_table()
    {
        ...
        $this->log->info('Altering table product related table');
