...
class ProductCategories
{
    ...
    {
        $this->log = new Log('db.product-categories');
        $this->create_table();
        $this->alter_table();
    }
    ...
    {
        $this->log->info('Creating new productCategories if table not exists');
    ...
    public function alter_table()
    {
        ...
        $this->log->info('Altering table product categories table');
